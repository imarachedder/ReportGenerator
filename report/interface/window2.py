...
class Ui_MainWindow2(object):
    def setupUi (self, MainWindow2):
        ...
        self.cance_pushButton.clicked.connect(self.back_window)
    ...
    def retranslateUi (self, MainWindow2):
        ...
        self.label_8.setText(_translate("MainWindow2", "Подписант"))
        ...
        self.label_7.setText(_translate("MainWindow2", "Подписант"))
...
class Window2(QtWidgets.QMainWindow, Ui_MainWindow2):
    def __init__ (self, title = None, parent = None):
        ...
        self.next_pushButton.clicked.connect(self.get_info_window2)
        self.cance_pushButton.clicked.connect(self.back_window)
        self.contractor_lineEdit.setText('ООО "Сибирь Регион"')
        self.contractor_boss_lineEdit.setText('С.Л. Игнатенко')
        self.position_boss_contractorlineEdit.setText('Директор')
    ...
    def window3(self):
        if not self.tp_checkBox.isChecked() :
            ...
            if not self.road_city_radioButton.isChecked() and not self.roads_automobile_radioButton.isChecked():
                ...
                # self.get_info_lineEdit()
                self.window3 = window3.Window3(self.windowTitle(), self)
                self.window3.show()
...
def main ():
    ...
    window = Window2()  # Создаём объект класса Window2
