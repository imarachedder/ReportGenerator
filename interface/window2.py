...
import db
from interface import window3, connection
...
class Ui_MainWindow2(object):
    ...
    def retranslateUi(self, MainWindow2):
        ...
        # MainWindow2.setWindowTitle(_translate("MainWindow2", f"\"{self.road_name}\""))
...
class Window2(QtWidgets.QMainWindow, Ui_MainWindow2):
    def __init__(self, road_name=None, database_name=None):
        ...
        self.tp_checkBox.toggled['bool'].connect(self.tp_checkbox_true)
        self.dad_checkBox.toggled['bool'].connect(self.dad_checkbox_true)
        self.setWindowTitle(str(self.road))
    ...
    def tp_checkbox_true(self):
        ...
        print("Формирование отчета по технического паспорту")
        self.request = db.Query(self.database_name)
        print("успешно")
        # self.request.get_length_axis(self.road)
        # self.request.get_bindings(self.road)
    ...
    def dad_checkbox_true(self):
        ...
        self.request = db.Query(self.database_name)
        # self.request.get_length_axis(self.road)
        # self.request.get_carriageway_width(self.road)
        # print('#'*100, '\n\t\n')
        # self.request.get_longitudinal_slope(self.road)
        # print('#'*100, '\n\t\n')
        # self.request.get_iri(self.road)
        # print('#'*100, '\n\t\n')
        # self.request.get_rutting(self.road)
        self.request.get_dad_datas(self.road)

    def window3(self):
        self.window3 = window3.Window3()
        self.window3.show()
